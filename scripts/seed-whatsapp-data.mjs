...
import fs from 'fs';
fs.writeFileSync('temp_seed_whatsapp.sql', sql, 'utf8');
const out = execSync('npx supabase db query --linked --file ./temp_seed_whatsapp.sql', { encoding: 'utf-8' });
console.log('Seed Output:', out);
try { fs.unlinkSync('temp_seed_whatsapp.sql'); } catch(e) {}
