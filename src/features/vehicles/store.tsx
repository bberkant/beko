...
import type { Vehicle,VehicleInput,VehicleExpense,VehicleExpenseInput,Driver,DriverInput,TrafficFine,TrafficFineInput } from './types';
const C=createContext<any>(null); type R=Record<string,any>;
const vehicle=(r:R):Vehicle=>{
  let extra = { insuranceCompany: '', kaskoCompany: '', kaskoStartDate: '', dainiMurtehin: '' };
  ...
  return {
    ...
    insuranceDate:r.insurance_date??undefined,
    cascoDate:r.casco_date??undefined,
    status:r.status,
    insuranceCompany: extra.insuranceCompany || '',
    kaskoCompany: extra.kaskoCompany || '',
    kaskoStartDate: extra.kaskoStartDate || '',
    dainiMurtehin: r.daini_murtehin || extra.dainiMurtehin || '',
    purchasePrice: r.purchase_price ? Number(r.purchase_price) : 0,
    currentPrice: r.current_price ? Number(r.current_price) : 0,
