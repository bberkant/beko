...
export function CalendarPage(){
  ...
  return <div className="mx-auto max-w-7xl"><PageHeader title="Takvim" description="Ödeme, araç ve ihale son tarihlerini tek ekrandan takip edin." actions={<button className="btn-secondary" onClick={()=>{const d=new Date();setMonth(new Date(d.getFullYear(),d.getMonth(),1));setSelected(today)}}>Bugün</button>}/>
