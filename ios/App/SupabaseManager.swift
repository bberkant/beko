...
class SupabaseManager: ObservableObject {
    ...
    @Published var records: [SlaughterRecord] = []
    @Published var checks: [CheckRecord] = []
    @Published var vehicles: [VehicleRecord] = []
    @Published var tenders: [TenderRecord] = []
    @Published var realEstates: [RealEstateRecord] = []
    @Published var legalCases: [LegalCaseRecord] = []
    @Published var eInvoices: [EInvoiceRecord] = []
    
    @Published var loading: Bool = false
    @Published var organizationId: UUID = UUID(uuidString: "13b8da90-27d1-440d-a8f4-eb50dadd6391")!
    ...
    func addCheck(supplier: String, amount: Double, dueDate: String, bankName: String, checkNo: String, type: String = "cek") {
    ...
    var aggregatedCaris: [CariSummary] {
